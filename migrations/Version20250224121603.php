 ...
 */
final class Version20250224121603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, quantity INT DEFAULT NULL, min_stock INT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, description VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, image LONGTEXT NOT NULL, is_enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE used_machinery (id INT AUTO_INCREMENT NOT NULL, machinery_name VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, years_old INT NOT NULL, months INT NOT NULL, hours_of_use INT NOT NULL, last_service DATE NOT NULL, price DOUBLE PRECISION DEFAULT NULL, category VARCHAR(255) NOT NULL, image_filename VARCHAR(255) DEFAULT NULL, is_new TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(255) NOT NULL, phone VARCHAR(15) DEFAULT NULL, security_question VARCHAR(255) DEFAULT NULL, security_answer VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, reset_token VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
